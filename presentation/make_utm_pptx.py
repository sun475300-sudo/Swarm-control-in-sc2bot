...
def add_tag(slide, left, top, text, bg_color=CYAN, text_color=BG_DARK, w=None):
    ...
    shape = slide.shapes.add_shape(
        MSO_SHAPE.ROUNDED_RECTANGLE, left, top, width, Inches(0.32)
    )
    shape.fill.solid()
...
def add_card_with_header(
    slide, x, y, w, h, header, header_color, items, border_side="top"
):
...
def build_slide_2(prs):
    ...
    # Problem card
    add_rounded_rect(
        slide, Inches(0.6), Inches(1.7), Inches(5.8), Inches(2.3), BG_CARD, RED
    )
    add_text_box(
        slide,
        Inches(0.8),
    ...
    # Solution card
    add_rounded_rect(
        slide, Inches(6.7), Inches(1.7), Inches(5.8), Inches(2.3), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(6.9),
...
def build_slide_3(prs):
    ...
    flow = [
        ("Sensor Input", YELLOW),
        ("Flight Data Hub", CYAN),
        ("Decision Engine", PURPLE),
        ("MAVLink Cmd", GREEN),
    ]
    ...
    modules = [
        ...
        (
            ...
            "(= SC2 CombatManager)",
            [
                "Boids3DController: 군집 제어",
                "CollisionPredictor: TTC 예측",
                "CorridorManager: 회랑 관리",
                "AuthorityFSM: 긴급 모드",
                "PathPlanner: 경로 최적화",
            ],
        ),
    ...
    tbl_shape = slide.shapes.add_table(
        rows, cols, Inches(0.6), Inches(4.8), Inches(11.5), Inches(2.0)
    )
    tbl = tbl_shape.table
...
def build_slide_4(prs):
    ...
    add_rounded_rect(
        slide, Inches(0.5), Inches(2.1), Inches(6.0), Inches(4.6), BG_CARD, CYAN
    )
    add_text_box(
        slide,
        Inches(0.7),
    ...
    for i, (name, clr, params, desc) in enumerate(forces_sc2):
        ...
        dot = slide.shapes.add_shape(
            MSO_SHAPE.OVAL, Inches(0.75), y + Inches(0.05), Inches(0.15), Inches(0.15)
        )
        dot.fill.solid()
    ...
    add_rounded_rect(
        slide, Inches(6.8), Inches(2.1), Inches(5.8), Inches(4.6), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(7.0),
    ...
    for i, (name, clr, params, desc) in enumerate(forces_utm):
        y = Inches(2.55 + i * 0.8)
        dot = slide.shapes.add_shape(
            MSO_SHAPE.OVAL, Inches(7.05), y + Inches(0.05), Inches(0.15), Inches(0.15)
        )
        dot.fill.solid()
        dot.fill.fore_color.rgb = clr
        dot.line.fill.background()
...
def build_slide_5(prs):
    ...
    # Old method
    add_rounded_rect(
        slide, Inches(0.5), Inches(1.6), Inches(3.8), Inches(2.5), BG_CARD, RED
    )
    add_text_box(
        slide,
        Inches(0.7),
    ...
    # New method
    add_rounded_rect(
        slide, Inches(0.5), Inches(4.3), Inches(3.8), Inches(2.3), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(0.7),
    ...
    # Right: TTC formula
    add_rounded_rect(
        slide, Inches(4.6), Inches(1.6), Inches(4.0), Inches(3.0), BG_CARD, PURPLE
    )
    add_text_box(
        slide,
        Inches(4.8),
    ...
    # Alert levels table
    add_rounded_rect(
        slide, Inches(4.6), Inches(4.8), Inches(4.0), Inches(1.8), BG_CARD, YELLOW
    )
    add_text_box(
        slide,
        Inches(4.8),
    ...
    tbl_shape = slide.shapes.add_table(
        4, 3, Inches(4.8), Inches(5.3), Inches(3.6), Inches(1.2)
    )
    tbl = tbl_shape.table
    ...
    add_rounded_rect(
        slide, Inches(9.0), Inches(1.6), Inches(3.8), Inches(5.0), BG_CARD, CYAN
    )
    add_text_box(
        slide,
        Inches(9.2),
...
def build_slide_6(prs):
    ...
    add_rounded_rect(
        slide, Inches(0.5), Inches(1.6), Inches(6.0), Inches(3.2), BG_CARD, CYAN
    )
    add_text_box(
        slide,
        Inches(0.7),
    ...
    add_rounded_rect(
        slide, Inches(6.8), Inches(1.6), Inches(5.8), Inches(2.3), BG_CARD, YELLOW
    )
    add_text_box(
        slide,
        Inches(7.0),
    ...
    add_rounded_rect(
        slide, Inches(6.8), Inches(5.7), Inches(5.8), Inches(0.9), BG_CARD, RED
    )
    add_text_box(
        slide,
        Inches(7.0),
...
def build_slide_7(prs):
    ...
    for i, (name, clr, trigger, response, sc2) in enumerate(modes[:3]):
        y = Inches(1.5 + i * 1.65)
        add_rounded_rect(slide, Inches(0.5), y, Inches(6.0), Inches(1.45), BG_CARD, clr)
        add_text_box(
            slide,
            Inches(0.7),
            y + Inches(0.08),
    ...
    for i, (name, clr, trigger, response, sc2) in enumerate(modes[3:]):
        y = Inches(1.5 + i * 1.65)
        add_rounded_rect(slide, Inches(6.8), y, Inches(5.8), Inches(1.45), BG_CARD, clr)
        add_text_box(
            slide,
            Inches(7.0),
            y + Inches(0.08),
    ...
    add_rounded_rect(
        slide, Inches(6.8), Inches(4.8), Inches(5.8), Inches(1.7), BG_CARD, YELLOW
    )
    add_text_box(
        slide,
        Inches(7.0),
...
def build_slide_8(prs):
    ...
    # DroneState
    add_rounded_rect(
        slide, Inches(0.4), Inches(1.2), Inches(5.6), Inches(2.8), BG_CARD, CYAN
    )
    add_text_box(
        slide,
        Inches(0.6),
    ...
    # Point3D
    add_rounded_rect(
        slide, Inches(0.4), Inches(4.2), Inches(5.6), Inches(2.4), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(0.6),
    ...
    # CollisionAlert
    add_rounded_rect(
        slide, Inches(6.3), Inches(1.2), Inches(6.3), Inches(2.4), BG_CARD, RED
    )
    add_text_box(
        slide,
        Inches(6.5),
    ...
    # FlightCorridor
    add_rounded_rect(
        slide, Inches(6.3), Inches(3.8), Inches(6.3), Inches(1.8), BG_CARD, YELLOW
    )
    add_text_box(
        slide,
        Inches(6.5),
    ...
    # Spatial indexing
    add_rounded_rect(
        slide, Inches(6.3), Inches(5.8), Inches(6.3), Inches(0.85), BG_CARD, PURPLE
    )
    add_text_box(
        slide,
        Inches(6.5),
...
def build_slide_9(prs):
    ...
    for i, (title, clr, items) in enumerate(failsafes):
        x = Inches(0.4 + i * 4.2)
        add_rounded_rect(slide, x, Inches(1.5), Inches(3.9), Inches(2.4), BG_CARD, clr)
        add_text_box(
            slide,
            x + Inches(0.2),
            Inches(1.6),
    ...
    add_rounded_rect(
        slide, Inches(0.4), Inches(4.1), Inches(6.0), Inches(2.5), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(0.6),
    ...
    tbl_shape = slide.shapes.add_table(
        5, 2, Inches(0.6), Inches(4.6), Inches(5.6), Inches(1.8)
    )
    tbl = tbl_shape.table
    ...
    # Safety regulations
    add_rounded_rect(
        slide, Inches(6.8), Inches(4.1), Inches(5.8), Inches(2.5), BG_CARD, PURPLE
    )
    add_text_box(
        slide,
        Inches(7.0),
...
def build_slide_10(prs):
    ...
    # Completed items
    add_rounded_rect(
        slide, Inches(0.4), Inches(1.2), Inches(5.6), Inches(4.2), BG_CARD, CYAN
    )
    add_text_box(
        slide,
        Inches(0.6),
    ...
    # Roadmap
    add_rounded_rect(
        slide, Inches(6.3), Inches(1.2), Inches(6.3), Inches(3.0), BG_CARD, YELLOW
    )
    add_text_box(
        slide,
        Inches(6.5),
    ...
    # Stats
    add_rounded_rect(
        slide, Inches(6.3), Inches(4.4), Inches(6.3), Inches(1.0), BG_CARD, GREEN
    )
    add_text_box(
        slide,
        Inches(6.5),
...
def main():
    ...
    output_path = (
        ...
        / "visuals"
        / "Swarm_Net_Presentation_v2.pptx"
    )
