...
# Enhanced Scouting System (kept as a fallback when V2 is unavailable;
# the module itself emits a DeprecationWarning on import — silence it so
# downstream test output stays clean.)
try:
