...
class EconomyManager:
    ...
    # NOTE: _prevent_resource_banking and _reduce_gas_workers each have a second,
    # newer definition later in this file. Python's last-definition-wins behaviour
    # means *those* implementations are what actually runs; the old simpler ones
    # that used to live here were dead code (queen/static-defense fallbacks have
    # since moved to QueenManager / DefenseCoordinator / EarlyDefenseSystem).
    # Removed the dead duplicates so future maintainers don't edit the wrong copy.
    ...
    # NOTE: The active _reduce_gas_workers is defined later (severity-tiered min
    # workers per extractor). The simpler "remove one worker" version that lived
    # here was shadowed and dead.
