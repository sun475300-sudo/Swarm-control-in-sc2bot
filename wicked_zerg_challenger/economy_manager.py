...
class EconomyManager:
    ...
    async def _build_defense_during_banking(self) -> None:
        """
        * Build defensive structures when minerals are banking *
    ...
    async def _prevent_resource_banking(self) -> None:
        ...
        * 자원 낭비 방지 *
        ...
        try:
            ...
            # *** Static defense fallback (Spines/Spores) when minerals overflow ***
            await self._build_defense_during_banking()
