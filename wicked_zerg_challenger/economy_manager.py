...
class EconomyManager:
    ...
    def _get_early_scout_pressure_state(self) -> dict:
        ...
        # NOTE: cheese_active and fast_gas already imply early game (fresh + ≤90s gas);
        # an explicit early_window gate is therefore redundant.
    ...
    # NOTE: _prevent_resource_banking() defined later (TechCoordinator-aware version);
    ...
    # NOTE: _reduce_gas_workers() defined later (gas-banking-aware version);
    # legacy duplicate removed (was overridden at runtime, F811).
