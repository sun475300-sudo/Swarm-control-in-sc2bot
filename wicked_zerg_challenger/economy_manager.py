...
class EconomyManager:
    ...
    # NOTE: an earlier ``_prevent_resource_banking`` lived here and was
    # silently overridden by the more comprehensive version below
    # (look for the next definition). Removed to avoid dead code.
    ...
    # NOTE: an earlier ``_reduce_gas_workers`` lived here and was silently
    # overridden by the more comprehensive version below. Removed.
