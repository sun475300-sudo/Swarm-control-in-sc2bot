...
class EconomyManager:
    ...
    # NOTE: A duplicate _prevent_resource_banking previously lived here. Python
    # silently shadowed it with the comprehensive version defined later in the
    # class (~line 2507). Removed to make the active definition canonical.
    ...
    # NOTE: A duplicate _reduce_gas_workers previously lived here. The
    # comprehensive version below (~line 3286) silently shadowed it; removed
    # to keep one canonical definition.
