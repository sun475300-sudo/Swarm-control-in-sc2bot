...
class RealtimeAwarenessEngine:
    ...
    def on_step(self, iteration: int) -> List[Override]:
        ...
        try:
            ...
            logger.debug(f"on_step failed at iteration {iteration}: {e}")
    ...
    def _capture_situation(self, game_time: float) -> None:
        ...
        if townhalls and s.enemy_visible_count > 0:
            try:
                ...
                logger.debug(f"_capture_situation enemy_near_base check failed: {e}")
        ...
        if UnitTypeId:
            try:
                ...
                logger.debug(f"_capture_situation tech_level check failed: {e}")
        ...
        if "protoss" in s.enemy_build_pattern.lower() or (
            ...
            if s.army_supply > 0 and s.game_time > 300:
                ...
                try:
                    ...
                    logger.debug(f"_detect_problems P14 counter-unit check failed: {e}")
    ...
    def _force_produce_gas_units(self) -> None:
        ...
        try:
            ...
            logger.debug(f"_force_produce_gas_units failed: {e}")
    ...
    def _force_army_production(self) -> None:
        ...
        try:
            ...
            logger.debug(f"_force_army_production failed: {e}")
    ...
    def _force_overlord_production(self) -> None:
        ...
        try:
            ...
            logger.debug(f"_force_overlord_production failed: {e}")
    ...
    def _flush_minerals(self) -> None:
        ...
        try:
            ...
            logger.debug(f"_flush_minerals failed: {e}")
