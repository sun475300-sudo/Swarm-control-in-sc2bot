...
try:
    ...
    # sc2 isn't installed in this environment (e.g. running tests without the
    # game client dependency) — fall back to standalone enums with the same
    # members so ladder/lookup logic below still works.
