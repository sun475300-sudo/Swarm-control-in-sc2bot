...
def main():
    ...
    for iteration in range(1, 6):
        ...
        if success1:
            ...
            logger.error(
                f"Auto error fixing had issues in iteration {iteration}, continuing..."
            )
        ...
        if success2:
            ...
            logger.warning(
                f"Code quality check had issues in iteration {iteration}, continuing..."
            )
            iteration_success = False
        ...
        if success3:
            ...
            logger.warning(
                f"Game training had issues in iteration {iteration}, continuing..."
            )
            iteration_success = False
        ...
        if success4:
            logger.info(
                f"Replay build order learning completed for iteration {iteration}"
            )
            logger.info(
                "Learned parameters will be automatically applied via config.py"
            )
        else:
            logger.warning(
                f"Replay build order learning had issues in iteration {iteration}, continuing..."
            )
            iteration_success = False
        ...
        if success5:
            logger.info(
                f"Replay comparison analysis completed for iteration {iteration}"
            )
        else:
            logger.warning(
                f"Replay comparison analysis had issues in iteration {iteration}, continuing..."
            )
            iteration_success = False
    ...
    logger.info(
        "  - Learned build orders: local_training/scripts/learned_build_orders.json"
    )
