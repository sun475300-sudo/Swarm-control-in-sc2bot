...
class TrainingVisualizer:
    ...
    def plot_progress(self):
        ...
        ax1.set_title(
            "Self-Evolution System: Learning Rate Adjustment",
            fontsize=14,
            fontweight="bold",
        )
        ...
        if history:
            ...
            for h in history:
                ...
                ax1.annotate(
                    ...
                    ha="center",
                    fontsize=8,
                    color="blue" if h["action"] == "increase" else "red",
                )
        else:
            ax1.text(
                0.5, 0.5, "No Learning Rate Adjustments Yet", ha="center", va="center"
            )
        ...
        ax2.set_title(
            "Training Performance: Win Rate Trend", fontsize=14, fontweight="bold"
        )
