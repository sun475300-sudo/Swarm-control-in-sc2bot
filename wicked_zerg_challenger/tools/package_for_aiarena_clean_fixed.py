...
class AIArenaPackager:
 ...
 # Default path - must be set via environment variable
                # Set ARENA_DEPLOY_PATH="D:/아레나_배포/deployment" or use --output argument
 raise ValueError(
                    "Output directory not specified. "
                    "Please use --output argument or set ARENA_DEPLOY_PATH environment variable. "
                    "Example: --output 'D:/아레나_배포/deployment'"
 )
...
def main():
 ...
 type=str,
 default=None,
        help="Output directory for zip file (default: D:\\아레나_배포\\deployment or ARENA_DEPLOY_PATH env var)"
 )
 parser.add_argument(
        "--project-root",
 type=str,
