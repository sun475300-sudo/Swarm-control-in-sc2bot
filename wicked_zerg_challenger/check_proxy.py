...
def main(proxy_path: str | None = None) -> int:
    if proxy_path is None:
        proxy_path = os.environ.get(
            "CLI_PROXY_API_PATH",
            r"C:\Users\sun47\AppData\Local\Microsoft\WinGet\Packages\LuisPater.CLIProxyAPI_Microsoft.Winget.Source_8wekyb3d8bbwe\cli-proxy-api.exe",
        )
