...
class UserDrone:
    ...
    def update(self, dt):
        ...
        if self.state == STATE_EVICTING:
            ...
            self.entity.scale = Vec3(
                self.base_scale * p, self.base_scale * p, self.base_scale * p
            )
            self._sync()
            self._refresh_label()
        ...
        if self.timer > TIMER_WARN:
            ...
            self.entity.scale = Vec3(self.base_scale, self.base_scale, self.base_scale)
