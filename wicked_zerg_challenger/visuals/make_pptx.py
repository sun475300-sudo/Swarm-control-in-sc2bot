...
def add_tag_label(slide, left, top, text, bg_color=CYAN, text_color=BG_DARK):
    ...
    shape = slide.shapes.add_shape(
        MSO_SHAPE.ROUNDED_RECTANGLE, left, top, Inches(2.4), Inches(0.34)
    )
    shape.fill.solid()
...
def build_slide_1(prs):
    ...
    add_image(
        slide, "slide1_swarm_hex.png", Inches(8.3), Inches(1.0), width=Inches(4.5)
    )
...
def build_slide_2(prs):
    ...
    add_image(
        slide, "slide2_radar_gap.png", Inches(7.5), Inches(0.3), width=Inches(5.5)
    )
    ...
    # Stats bar
    stats = [
        ("90만+", "국내 등록 무인비행장치 (2025)"),
        ("+30%", "산업용 드론 비행 연간 증가율"),
        ("67%", "도심 저고도 관제 사각지대 비율"),
    ]
...
def build_slide_3(prs):
    ...
    add_image(
        slide, "slide3_mobile_atc.png", Inches(8.8), Inches(0.8), width=Inches(4.0)
    )
...
def build_slide_5(prs):
    ...
    add_image(
        slide, "slide5_3d_tracking.png", Inches(6.5), Inches(0.3), width=Inches(6.5)
    )
...
def build_slide_6(prs):
    ...
    add_image(
        slide, "slide6_timer_dash.png", Inches(7.0), Inches(0.3), width=Inches(6.0)
    )
...
def build_slide_7(prs):
    ...
    add_image(
        slide, "slide7_comparison.png", Inches(6.5), Inches(2.8), width=Inches(6.5)
    )
...
def build_slide_8(prs):
    ...
    add_image(slide, "slide8_roadmap.png", Inches(1.5), Inches(5.0), width=Inches(10.0))

    add_tag_label(
        slide, Inches(4.5), Inches(0.8), "CONCLUSION & ROADMAP", CYAN, BG_DARK
    )
