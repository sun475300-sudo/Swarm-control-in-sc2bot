...
class ProductionResilience:
    ...
    # NOTE: legacy build_terran_counters that lived here was removed — it was
    # silently shadowed by the more advanced TechCoordinator-aware version
    # later in this file (F811). See IMPROVEMENT_LIST_2026-05-07.md (B5).
