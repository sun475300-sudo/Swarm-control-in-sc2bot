...
class ProductionResilience:
    ...
    # NOTE: an earlier draft of `build_terran_counters` lived here. The
    # canonical implementation lower in this file (TechCoordinator-aware,
    # priority-managed Baneling Nest construction) shadowed it via Python's
    # class-body redefinition rule, so this stub was dead code. Removed.
