...
class ProductionResilience:
    ...
    # NOTE: an earlier ``build_terran_counters`` used to live here. It was
    # silently overridden by a later definition with the same name (Python
    # keeps the last def), so its body never executed. Removed; the canonical
