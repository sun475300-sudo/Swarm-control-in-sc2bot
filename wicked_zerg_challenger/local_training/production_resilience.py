...
class ProductionResilience:
    ...
    # NOTE: ``build_terran_counters`` 의 구버전이 여기 있었다. Python class 가
    # 같은 메서드명을 두 번 정의하면 뒤쪽 정의가 무조건 덮어쓰므로 이 구버전은
    # 실행되지 않는 dead code 였다. TechCoordinator 통합본(line ~1977) 만 유지.
