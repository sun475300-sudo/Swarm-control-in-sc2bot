...
class ProductionResilience:
    ...
    # NOTE: an earlier `build_terran_counters` previously lived here. It was
    # shadowed by the TechCoordinator-aware version defined later in the
    # class and never reachable at runtime. Removed to avoid F811 noise.
