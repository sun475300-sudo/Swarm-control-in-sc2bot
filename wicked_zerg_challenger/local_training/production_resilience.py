...
class ProductionResilience:
    ...
    # NOTE: ``build_terran_counters`` is defined further below (~line 1866)
    # with a richer TechCoordinator-aware flow. The previous, simpler version
    # that lived here was silently shadowed by that later definition, so it
    # was dead code. Removed to keep a single canonical implementation.
