...
class ProductionResilience:
    ...
    # NOTE: build_terran_counters defined further down — uses TechCoordinator.
    # The earlier direct-build version was removed to stop the second
    # definition from silently shadowing it (ruff F811).
