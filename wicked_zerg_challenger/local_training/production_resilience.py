...
class ProductionResilience:
    ...
    # NOTE: An older `build_terran_counters` lived here that handled only
    # Baneling Nest construction. It was shadowed by the TechCoordinator-aware
    # version defined later in this class (anti-Roach upgrades and broader
    # counter coverage), so the older one was dead code and has been removed.
