...
class ProductionResilience:
    ...
    # NOTE: build_terran_counters previously had a duplicate definition above
    # this point that was silently shadowed by the TechCoordinator-aware
    # implementation defined later in this class. Removed to make the
    # active implementation unambiguous.
