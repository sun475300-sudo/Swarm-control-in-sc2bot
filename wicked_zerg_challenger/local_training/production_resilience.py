...
class ProductionResilience:
    ...
    async def _produce_army_unit(self, larva, ignore_caps=False) -> bool:
        ...
        if not ignore_caps:
            ...
            # Defense is met — hold larvae if we should be saving for the next Hatchery.
    ...
    # NOTE: an earlier ``build_terran_counters`` lived here and was
    # silently overridden by the TechCoordinator-aware version further
    # below. Removed.
