...
class GameStateBlackboard:
    ...
    # Hatchery costs 300m; require a small buffer so we don't sit at zero
    # right after starting the expansion.
    EXPAND_MINERALS_THRESHOLD = 300
    ...
    def should_expand(self) -> bool:
        ...
        return (
            ...
            and not self.is_under_attack
            and self.resources.minerals >= self.EXPAND_MINERALS_THRESHOLD
        )


# Backwards-compatible alias used by callers and tests.
