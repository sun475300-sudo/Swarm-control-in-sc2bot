                    ...
                    if nearby_targets:
                        ...
                        if infestor.energy >= 100:  # Neural Parasite costs 100 energy
                            try:
                                ...
                                logger.debug(f"Infestor Neural Parasite failed: {e}")
                ...
                if len(nearby_enemies) >= 3:  # At least 3 enemies for fungal
                    ...
                    if best_target and infestor.energy >= 75:  # Fungal costs 75 energy
                        try:
                            ...
                            logger.debug(f"Infestor Fungal Growth failed: {e}")
                ...
                if (
                    ...
                    if consume_target:
                        try:
                            ...
                            logger.debug(f"Viper Consume failed: {e}")
                    ...
                    if nearby_targets:
                        ...
                        if viper.energy >= 75:  # Abduct costs 75 energy
                            try:
                                ...
                                logger.debug(f"Viper Abduct failed: {e}")
                    ...
                    if nearby_air:
                        ...
                        if viper.energy >= 125:  # Parasitic Bomb costs 125 energy
                            try:
                                ...
                                logger.debug(f"Viper Parasitic Bomb failed: {e}")
                    ...
                    if nearby_ground:
                        ...
                        if (
                            ...
                            try:
                                ...
                                logger.debug(f"Viper Blinding Cloud failed: {e}")
            ...
            if enemy_structures and enemy_structures.exists:
                ...
                if townhalls:
                    ...
                    if nearby_townhalls:
                        ...
                        try:
                            ...
                            logger.debug(f"Ravager Bile (townhall target) failed: {e}")
                ...
                if nearby_structures:
                    ...
                    try:
                        ...
                        logger.debug(f"Ravager Bile (nearby structure) failed: {e}")
                ...
                if high_value_units:
                    ...
                    if nearby_high_value:
                        ...
                        try:
                            ...
                            logger.debug(f"Ravager Bile (high-value target) failed: {e}")
                ...
                if len(nearby_enemies) >= 3:
                    ...
                    if best_position:
                        try:
                            ...
                            logger.debug(f"Ravager Bile (clumped position) failed: {e}")
        ...
        for baneling in banelings:
            ...
            if len(nearby_enemies) >= 5:
                try:
                    ...
                    logger.debug(f"Baneling explode (enemy cluster) failed: {e}")
            ...
            if health_ratio < 0.5 and len(nearby_enemies) >= 2:
                try:
                    ...
                    logger.debug(f"Baneling explode (low health) failed: {e}")
        ...
        for overseer in overseers:
            ...
            if nearby_buildings:
                ...
                try:
                    ...
                    logger.debug(f"Overseer Contaminate failed: {e}")
