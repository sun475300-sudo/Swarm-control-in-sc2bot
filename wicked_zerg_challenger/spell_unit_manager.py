                ...
                if (
                    ...
                    if consume_target:
                        try:
                            ...
                            logger.debug(f"viper consume failed: {e!r}")
                    ...
                    if nearby_targets:
                        ...
                        if viper.energy >= 75:  # Abduct costs 75 energy
                            try:
                                ...
                                logger.debug(f"viper abduct failed: {e!r}")
                    ...
                    if nearby_air:
                        ...
                        if viper.energy >= 125:  # Parasitic Bomb costs 125 energy
                            try:
                                ...
                                logger.debug(f"viper third ability cast failed: {e!r}")
                    ...
                    if nearby_ground:
                        ...
                        if (
                            ...
                            try:
                                ...
                                logger.debug(f"viper fourth ability cast failed: {e!r}")
            ...
            if enemy_structures and enemy_structures.exists:
                ...
                if townhalls:
                    ...
                    if nearby_townhalls:
                        ...
                        try:
                            ...
                            logger.debug(f"ravager bile vs enemy base failed: {e!r}")
                ...
                if nearby_structures:
                    ...
                    try:
                        ...
                        logger.debug(f"ravager bile vs target failed: {e!r}")
                ...
                if high_value_units:
                    ...
                    if nearby_high_value:
                        ...
                        try:
                            ...
                            logger.debug(f"ravager bile attempt failed: {e!r}")
        ...
        for baneling in banelings:
            ...
            if len(nearby_enemies) >= 5:
                try:
                    ...
                    logger.debug(f"baneling explode (target chase) failed: {e!r}")
            ...
            if health_ratio < 0.5 and len(nearby_enemies) >= 2:
                try:
                    ...
                    logger.debug(f"baneling explode (proximity) failed: {e!r}")
        ...
        for overseer in overseers:
            ...
            if nearby_buildings:
                ...
                try:
                    ...
                    logger.debug(f"overseer contaminate failed: {e!r}")
