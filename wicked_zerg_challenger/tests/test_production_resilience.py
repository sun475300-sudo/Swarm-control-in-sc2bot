...
class TestProductionResilience(unittest.IsolatedAsyncioTestCase):
    ...
    def test_get_counter_unit_terran_marine(self):
        ...
        enemy_units = [self._make_enemy_unit(UnitTypeId.MARINE) for _ in range(6)]
        # Bot has Roach Warren ready, no Hydralisk Den, no Spire
    ...
    def test_get_counter_unit_zerg(self):
        ...
        enemy_units = [self._make_enemy_unit(UnitTypeId.ROACH) for _ in range(5)]
        result = self.resilience._get_counter_unit(
