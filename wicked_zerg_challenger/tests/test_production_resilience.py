...
class TestProductionResilience(unittest.IsolatedAsyncioTestCase):
    ...
    def test_get_counter_unit_terran_marine(self):
        ...
        # No baneling nest -> falls through to roach warren counter
    ...
    def test_get_counter_unit_protoss(self):
        """Test counter selection against Protoss (armored ground: Stalker)"""
        mock_stalker = Mock()
    ...
    def test_get_counter_unit_zerg(self):
        """Test counter selection against Zerg (air: Mutalisk)"""
        mock_muta = Mock()
