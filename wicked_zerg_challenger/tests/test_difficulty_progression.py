...
try:
    ...
    # difficulty_progression falls back to its own stub Enums when sc2 isn't
    # installed — reuse that exact stub so instances compare equal instead of
    # defining an independent Enum with the same names.
    from difficulty_progression import Difficulty, Race
