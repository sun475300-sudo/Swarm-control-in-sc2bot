...
### 5. 상위 테크 건물 및 여왕 작업 문제 (2026-01-15) ⚠️ **중요**
...
### 6. Android 앱 빌드 문제 (2026-01-15) ⚠️ **중요**
...
- **초기 개발 문제**: 4개 (async/await, 서플라이 블록, race condition, 미네랄 오버플로우)
...
8. `PROJECT_HISTORY_AND_ISSUES_RESOLVED.md` - 완전한 프로젝트 히스토리

### 인프라 관련 문서
9. `monitoring/mobile_app_android/ERROR_ANALYSIS_AND_FIX.md` - Android 앱 에러 분석 및 해결
10. `monitoring/mobile_app_android/NETWORK_TIMEOUT_FIX.md` - 네트워크 타임아웃 해결
11. `monitoring/mobile_app_android/SERVER_MANAGEMENT.md` - 서버 관리 가이드
12. `monitoring/두_모바일_앱_차이점_비교.md` - 모바일 앱 비교
