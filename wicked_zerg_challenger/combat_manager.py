...
class CombatManager:
    ...
    # NOTE: a simpler _find_harass_target lived here, but was shadowed by
    # the later definition (Priority 1: enemy workers, Priority 2: isolated
    # tech buildings, fallback: enemy base). Deleted to match runtime.
