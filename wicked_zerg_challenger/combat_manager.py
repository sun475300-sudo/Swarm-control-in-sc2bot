...
class CombatManager:
    ...
    # NOTE: an earlier, simpler `_find_harass_target` used to live here.
    # It was shadowed by the worker-priority/tech-building version at the
    # bottom of this class (~line 5000), so this simple one was never
    # actually invoked. Removed; if you need the old fallback-only
    # behaviour, see git history (combat_manager.py prior to sweep #14).
