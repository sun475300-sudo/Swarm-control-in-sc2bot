...
class CombatManager:
    ...
    # It was shadowed by the worker-prioritising version defined later in the
    # class (search for `_find_harass_target` below) and never reachable at
    # runtime. Removed to avoid F811 noise and reader confusion.
