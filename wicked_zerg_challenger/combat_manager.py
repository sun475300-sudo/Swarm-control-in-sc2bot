...
class CombatManager:
    ...
    # NOTE: an earlier, simpler ``_find_harass_target`` used to live here and
    # was silently shadowed by the prioritised version further down in the
    # class (workers > isolated tech > base fallback). Removed so the rich
    # selector is the only one in play.
