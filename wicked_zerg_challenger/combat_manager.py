...
class CombatManager:
    ...
    def _is_base_under_attack(self) -> bool:
        ...
        # NOTE: any 3+ enemies near a base counts as a threat regardless
        # of whether they're combat or non-combat (scouts/workers).  A
        # previously-defined `non_combat_names` filter was unused.
