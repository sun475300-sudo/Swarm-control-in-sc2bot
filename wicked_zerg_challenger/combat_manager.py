...
class CombatManager:
    ...
    # NOTE: _find_harass_target previously had a duplicate definition here that
    # was silently shadowed by the comprehensive version below. Removed to make
    # the single canonical version unambiguous (see line ~4278).
