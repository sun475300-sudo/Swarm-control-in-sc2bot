...
class CombatManager:
    ...
    # NOTE: An older simpler `_find_harass_target` previously lived here that
    # only returned the enemy main base or first structure. It was shadowed by
    # the worker-prioritising version defined later in this class, making it
