...
class CombatManager:
    ...
    # NOTE: The active _find_harass_target (workers-then-tech-buildings priority)
    # lives later in this file; the simpler "just hit the main" version that
    # was here used to shadow it via duplicate definition. Removed.
