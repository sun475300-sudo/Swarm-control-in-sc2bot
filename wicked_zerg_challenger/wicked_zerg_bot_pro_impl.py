    ...
    async def on_step(self, iteration: int):
        ...
        if self.scoring_system:
            try:
                ...
                self.logger.debug("scoring_system.on_step error: %s", e)
        ...
        if self.awareness_engine:
            try:
                ...
                self.logger.debug("awareness_engine.on_step error: %s", e)
    ...
    async def on_end(self, game_result):
        ...
        if self.awareness_engine:
            try:
                ...
                self.logger.debug("awareness_engine summary error: %s", e)
