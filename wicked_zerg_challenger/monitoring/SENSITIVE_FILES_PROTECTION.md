...
**작성일**: 2026-01-15  
**목적**: API 키 및 민감한 정보가 포함된 파일의 Git 추적 방지
...
- [x] `REMOVE_API_KEY_FROM_GIT_HISTORY.md`에서 실제 키 제거
- [x] `remove_api_key_from_git_history.sh`에서 실제 키 제거

### 추가 확인 필요

- [ ] 이미 Git에 추적 중인 민감한 파일 확인
- [ ] Git 히스토리에서 실제 API 키 검색
- [ ] 필요시 Git 히스토리 정리
