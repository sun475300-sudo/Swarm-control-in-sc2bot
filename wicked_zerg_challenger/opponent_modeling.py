...
class OpponentModeling:
    ...
    async def on_step(self, iteration: int):
        """매 프레임 실행"""
        # Guard: bot/opponent must be initialized (merged from previous duplicate
        # on_step at line ~765 — duplicate removed because Python silently shadowed
        # this comprehensive version with a smaller one)
