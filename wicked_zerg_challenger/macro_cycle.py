...
class MacroCycleManager:
    ...
    def _update_queen_assignments(self) -> None:
        ...
        try:
            ...
            logger.debug(f"queen tag enumeration failed: {e!r}")
        ...
        if supply_cap < 200:
            ...
            if supply_left <= threshold:
                ...
                try:
                    ...
                    logger.debug(f"already_pending(OVERLORD) failed: {e!r}")
    ...
    def _update_larva_efficiency(self) -> None:
        ...
        try:
            ...
            logger.debug(f"larva efficiency update failed: {e!r}")
    ...
    def _place_creep_tumor(self, queen) -> bool:
        ...
        try:
            ...
            logger.debug(f"queen creep tumor placement failed: {e!r}")
        return False
    ...
    def get_larva_priority_list(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.debug(f"drone count probe failed: {e!r}")
