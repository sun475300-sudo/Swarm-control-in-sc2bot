...
class UnitFactory:
    ...
    async def on_step(self, iteration: int) -> None:
        ...
        # 2. Direct access fallback when Blackboard missing — the
        # `emergency_active` flag on StrategyManager is checked again below
        # via getattr() so no additional sync is needed here.
