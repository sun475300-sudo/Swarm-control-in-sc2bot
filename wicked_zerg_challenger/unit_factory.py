...
# Reserve some larvae for tech unit morphing when enemy attack intent not
# confirmed
...
# CRITICAL: Enhanced responsiveness - When scouting detects enemy tech
...
if not tech_detected_recently and scout and hasattr(
        scout, "enemy_tech_detected"):
