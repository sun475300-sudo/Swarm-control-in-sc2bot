...
class UnitFactory:
    ...
    async def on_step(self, iteration: int) -> None:
        ...
        # 2. Fallback to direct access happens implicitly via the
        #    'strategy = getattr(self.bot, "strategy_manager", None)' below;
        #    emergency_active is read from strategy.emergency_active in the
        #    if-branch a few lines down.
