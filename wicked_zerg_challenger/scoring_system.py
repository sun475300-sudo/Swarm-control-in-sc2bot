...
class ScoringSystem:
    ...
    def on_step(self, iteration: int) -> None:
        ...
        try:
            ...
            logger.debug("evaluate_all error: %s", e)
    ...
    def _evaluate_defense(self, game_time: float) -> None:
        ...
        if base_count < self._last_base_count and self._last_base_count > 0:
            ...
            try:
                ...
                logger.debug("near_base_enemies count error: %s", e)
        ...
        if structures and hasattr(structures, "__call__"):
            try:
                ...
                logger.debug("idle queen check error: %s", e)
        ...
        if game_time < 180:
            ...
            if structures and hasattr(structures, "__call__"):
                try:
                    ...
                    logger.debug("lair/hive check error: %s", e)
        else:
            # 후반: 200 서플 + 공격
            if supply_used >= 180:
    ...
    def _evaluate_micro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug("idle army micro check error: %s", e)
    ...
    def _evaluate_macro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug("creep tumor macro check error: %s", e)
    ...
    def _save_game_score(self, report: Dict) -> None:
        ...
        try:
            ...
            logger.warning("save game report failed: %s", e)
    ...
    def _load_cumulative_score(self) -> Dict:
        ...
        try:
            ...
            logger.warning("load cumulative score failed: %s", e)
    ...
    def _save_cumulative_score(self) -> None:
        ...
        try:
            ...
            logger.warning("save cumulative score failed: %s", e)
