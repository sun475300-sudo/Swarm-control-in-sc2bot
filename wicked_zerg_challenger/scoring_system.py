...
class ScoringSystem:
    ...
    def on_step(self, iteration: int) -> None:
        ...
        try:
            ...
            logger.debug(f"score evaluation failed: {e!r}")
    ...
    def _evaluate_defense(self, game_time: float) -> None:
        ...
        if base_count < self._last_base_count and self._last_base_count > 0:
            ...
            try:
                ...
                logger.debug(f"near_base_enemies scan failed: {e!r}")
        ...
        if structures and hasattr(structures, "__call__"):
            try:
                ...
                logger.debug(f"idle queen evaluation failed: {e!r}")
        ...
        if game_time < 180:
            ...
            if structures and hasattr(structures, "__call__"):
                try:
                    ...
                    logger.debug(f"tech-tier evaluation failed: {e!r}")
        else:
            # 후반: 200 서플 + 공격
            if supply_used >= 180:
    ...
    def _evaluate_micro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug(f"idle army evaluation failed: {e!r}")
    ...
    def _evaluate_macro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug(f"creep tumor evaluation failed: {e!r}")
    ...
    def _save_game_score(self, report: Dict) -> None:
        ...
        try:
            ...
            logger.warning(f"failed to persist score history: {e!r}")
    ...
    def _load_cumulative_score(self) -> Dict:
        ...
        try:
            ...
            logger.warning(f"failed to load cumulative score, resetting: {e!r}")
    ...
    def _save_cumulative_score(self) -> None:
        ...
        try:
            ...
            logger.warning(f"failed to save cumulative score: {e!r}")
