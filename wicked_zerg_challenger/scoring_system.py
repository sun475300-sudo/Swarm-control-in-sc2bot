...
class ScoringSystem:
    ...
    def on_step(self, iteration: int) -> None:
        ...
        try:
            ...
            logger.debug(f"on_step evaluation failed at t={game_time:.1f}: {e}")
    ...
    def _evaluate_defense(self, game_time: float) -> None:
        ...
        if base_count < self._last_base_count and self._last_base_count > 0:
            ...
            try:
                ...
                logger.debug(f"defense proximity scan failed: {e}")
        ...
        if structures and hasattr(structures, "__call__"):
            try:
                ...
                logger.debug(f"queen inject scoring skipped: {e}")
        ...
        if game_time < 180:
            ...
            if structures and hasattr(structures, "__call__"):
                try:
                    ...
                    logger.debug(f"tech tier scoring skipped: {e}")
        else:
            # 후반: 200 서플 + 공격
            if supply_used >= 180:
    ...
    def _evaluate_micro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug(f"micro idle scoring skipped: {e}")
    ...
    def _evaluate_macro(self, game_time: float) -> None:
        ...
        try:
            ...
            logger.debug(f"creep tumor scoring skipped: {e}")
    ...
    def _save_game_score(self, report: Dict) -> None:
        ...
        try:
            ...
            logger.warning(f"failed to save game scores: {e}")
    ...
    def _load_cumulative_score(self) -> Dict:
        ...
        try:
            ...
            logger.warning(f"failed to load cumulative score: {e}")
    ...
    def _save_cumulative_score(self) -> None:
        ...
        try:
            ...
            logger.warning(f"failed to save cumulative score: {e}")
