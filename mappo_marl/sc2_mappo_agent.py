...
if HAS_TORCH:
    ...
    SharedObsEncoderTorch = None  # type: ignore[assignment,misc]
...
if HAS_TORCH:
    ...
    CentralizedCriticTorch = None  # type: ignore[assignment,misc]
...
if HAS_TORCH:
    ...
    DecentralizedActorTorch = None  # type: ignore[assignment,misc]
