...
try:
    ...
    HAS_TORCH = False
    # Stand-in stubs so module import does not crash with NameError
    # when the Torch class bodies are parsed below. The classes are
    # only ever instantiated when HAS_TORCH is True.
