...
def generate_sc2_dataset(n: int = 500) -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "map_name": np.random.choice(["Berlingrad", "Ancient Cistern", "Equilibrium"], n),
        ...
        "league": np.random.choice(["Bronze", "Silver", "Gold", "Platinum", "Diamond", "Master", "Grandmaster"], n),
    })
...
def build_sc2_expectation_suite() -> ExpectationSuite:
    ...
    suite.add_expectation(ExpectationConfiguration(
        ...
        kwargs={"column_list": [
            "game_id", "player_id", "race", "opponent_race", "map_name",
            "apm", "game_duration", "supply_peak", "minerals_spent",
            "gas_spent", "workers_produced", "winner", "league",
        ]},
    ))
