...
class SC2BotService(Construct):
    ...
    def __init__(self, scope: Construct, id: str, cluster: eks.Cluster, **kwargs) -> None:
...
app   = cdk.App()
SC2BotInfraStack(
    app, "SC2BotInfraStack",
    env=cdk.Environment(account=os.environ.get("CDK_ACCOUNT", "123456789012"),
