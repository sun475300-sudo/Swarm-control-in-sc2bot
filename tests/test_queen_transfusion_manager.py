...
class TestQueenTransfusionManager:
    ...
    def test_valid_transfusion_target_hp_threshold(self):
        ...
        assert self.manager._is_valid_transfusion_target(target_low_hp, queen) is True

        # 70% HP should be invalid (above 60% threshold)
        assert self.manager._is_valid_transfusion_target(target_high_hp, queen) is False
    ...
    def test_blacklisted_unit_not_valid(self):
        ...
        assert self.manager._is_valid_transfusion_target(baneling, queen) is False
    ...
    def test_range_check(self):
        ...
        assert self.manager._is_valid_transfusion_target(target_close, queen) is True

        # Far target should be invalid (distance=50 > 7 range)
        assert self.manager._is_valid_transfusion_target(target_far, queen) is False
