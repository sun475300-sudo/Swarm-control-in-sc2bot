...
class TestEconomyGasBanking:
    ...
    def test_gas_overflow_threshold_lowered(self):
        """Gas overflow threshold should be aggressively low (<=1000) to prevent banking."""
        # Original Phase 10 fix lowered 3000 -> 1000; later tuning lowered it
        # further to 800 to react faster.  Keep the assertion future-proof.
