...
class TestEconomyGasBanking:
    ...
    def test_gas_overflow_threshold_lowered(self):
        """Gas overflow threshold has been progressively lowered (3000 → 1000 → 800).

        Anything at or below 1000 prevents excessive gas banking; assert the
        current production value (800) and the upper safety bound.
        """
