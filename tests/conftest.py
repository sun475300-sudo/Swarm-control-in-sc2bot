...
# s2clientprotocol ships _pb2.py files generated by an older protoc than the
# protobuf runtime pip resolves by default, which raises
# "TypeError: Descriptors cannot be created directly" on import. Must be set
# before sc2/s2clientprotocol are imported anywhere in the test session.
