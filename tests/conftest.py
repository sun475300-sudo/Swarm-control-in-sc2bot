...
# sc2 라이브러리(s2clientprotocol)가 생성한 _pb2.py가 설치된 protobuf 런타임보다
# 낮은 protoc으로 생성돼 있어 upb 구현으로는 "Descriptors cannot be created
# directly" TypeError가 발생한다. 순수 파이썬 구현으로 강제 전환해 회피한다.
