...
# sc2 (burnysc2)의 generated s2clientprotocol _pb2.py 파일은 오래된 protoc으로
# 생성되어, 최신 protobuf 패키지의 C++/upb 구현과 충돌해
# "TypeError: Descriptors cannot be created directly" 를 일으킬 수 있다.
# wicked_zerg_challenger/tests/conftest.py 와 동일한 워크어라운드.
