"""
Scenario 18 - Auto-generated execution script.
This script demonstrates running the bot in scenario 18.
"""
...
def main() -> None:
    """Run scenario 18 simulation."""
    print("="*70)
    print(f"Scenario 18 Simulation")
    print("="*70)
    print()
    
    env = MockSC2Env(initial_minerals=280)
