"""
Scenario 20 - Auto-generated execution script.
This script demonstrates running the bot in scenario 20.
"""
...
def main() -> None:
    """Run scenario 20 simulation."""
    print("="*70)
    print(f"Scenario 20 Simulation")
    print("="*70)
    print()
    
    env = MockSC2Env(initial_minerals=300)
