"""
Scenario 14 - Auto-generated execution script.
This script demonstrates running the bot in scenario 14.
"""
...
def main() -> None:
    """Run scenario 14 simulation."""
    print("="*70)
    print(f"Scenario 14 Simulation")
    print("="*70)
    print()
    
    env = MockSC2Env(initial_minerals=240)
