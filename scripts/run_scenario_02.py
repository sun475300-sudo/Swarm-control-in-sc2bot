"""
Scenario 2 - Auto-generated execution script.
This script demonstrates running the bot in scenario 2.
"""
...
def main() -> None:
    ...
    print("="*70)
    print(f"Scenario 2 Simulation")
    print("="*70)
    print()
    
    env = MockSC2Env(initial_minerals=120)
