...
| ID | 설명 | 우선순위 | 상태 |
|----|------|---------|------|
| N1 | `OpponentModeling.on_step` 중복 정의 (line 341 vs 765 — F811) | 🟠 HIGH | ✅ resolved — 2026-07-07 점검 결과 단일 정의만 존재 (문서 stale) |
| N2 | `EconomyManager._prevent_resource_banking` / `_reduce_gas_workers` 재정의 (F811) | 🟡 MED | ✅ resolved — 2026-07-07 점검 결과 단일 정의만 존재 (문서 stale) |
| N3 | `combat_manager._find_harass_target` 재정의 (line 2377 vs 4278) | 🟡 MED | ✅ resolved — 2026-07-07 점검 결과 단일 정의만 존재 (문서 stale) |
| N4 | `production_resilience.build_terran_counters` 재정의 (1369 vs 1866) | 🟡 MED | ✅ resolved — 2026-07-07 점검 결과 단일 정의만 존재 (문서 stale) |
