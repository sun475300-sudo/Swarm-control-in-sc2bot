...
**Last refreshed:** 2026-07-12 (N1-N4 확인 결과 이미 해결된 상태 — 문서 stale)
...
| ID | 설명 | 우선순위 | 상태 |
|----|------|---------|------|
| N1 | `OpponentModeling.on_step` 중복 정의 (line 341 vs 765 — F811) | 🟠 HIGH | ✅ resolved — 2026-07-12 확인: 현재 `on_step` 정의 1개뿐 (`flake8 --select=F811` 클린) |
| N2 | `EconomyManager._prevent_resource_banking` / `_reduce_gas_workers` 재정의 (F811) | 🟡 MED | ✅ resolved — 2026-07-12 확인: 각 메서드 정의 1개뿐 |
| N3 | `combat_manager._find_harass_target` 재정의 (line 2377 vs 4278) | 🟡 MED | ✅ resolved — 2026-07-12 확인: 정의 1개뿐 (line 4992) |
| N4 | `production_resilience.build_terran_counters` 재정의 (1369 vs 1866) | 🟡 MED | ✅ resolved — 2026-07-12 확인: 정의 1개뿐 (`local_training/production_resilience.py`) |
| N5 | bare `except Exception:` 다수 (≈360+) — 이번 PR에서 12건 처리, 잔여 다수 | 🟢 LOW | partial — 2026-07-12 기준 `wicked_zerg_challenger/`에 457건 잔존, 범위가 넓어 별도 PR로 분리 권장 |
