...
**Net result: requirements.txt install now works from a clean environment (previously failed outright); CI pipeline is no longer wedged behind lint; 12 real test failures fixed. Suite: 505 pass / 11 skip / 0 fail.**
